...
for dataset in "${dataset_name[@]}"; do
    python3 annotation_to_rank_reason.py -result_name $name -model_name e5 -dataset_name $dataset_name -dataset_option $dataset_option 
done
