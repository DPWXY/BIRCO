...
def main(args):
    ...
    for path in data_paths:
        ...
        if args.ce_model is not None:
            ...
            create_folder_if_not_exists(f"./reranked_results/{args.dataset}_empty")                
            with open(f"./reranked_results/{args.dataset}_empty/result_{filename}", "wb") as f:
                pickle.dump(reranked_results, f)

            print(f"finish running {args.dataset} {filename}")
            print(args.ce_prompt)
            return
